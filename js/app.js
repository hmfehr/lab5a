...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let prodThree = multiply(testArray[0], testArray[1])[0];
  let prodFour = multiply(prodThree, testArray[2])[0];

  let myStrFour = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${prodFour}.`;

  return [prodFour, myStrFour];
}
